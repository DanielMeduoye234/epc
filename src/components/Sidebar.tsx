...
const navigation = [
  ...
  { name: 'My Sheep (All)', href: '/dashboard/members', icon: Users, roles: ['shepherd'] },
  { name: 'All Individuals', href: '/dashboard/members', icon: Users, roles: ['bishop', 'super_admin'] },
  { name: 'My Sheep (Regular)', href: '/dashboard/regular-members', icon: Users, roles: ['shepherd'] },
